...
class Fight {
    ...
    calculate() {
        let deadText = ['', 'REKT', 'REMOVED', 'SHIVVED', 'GUTTED', 'NEUTRALISED', 'PUT DOWN', 'SNUFFED', 'ICED', 'SLAIN', 'MASSACRED', 'SHREDDED', 'BIG OOF', 'DESTROZADO', 'DECIMATED', 'DESTROYED', 'SCHOOLED', 'SHELLED', 'DEAD', 'ELIMINATED', 'MURDERED', 'STEAMED', 'SMOKED']
