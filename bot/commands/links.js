module.exports = {
  ...
  execute: function(message, argsStr, replyData/*, dbData*/) {
    ...
    replyData.discord.fields.push({ name: 'Invite this bot to your server:', value: 'https://discord.com/oauth2/authorize?client_id=593507058905645057&scope=bot&permissions=2147576904' })
