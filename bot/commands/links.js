module.exports = {
  name: 'links',
  description: 'show the link to invite the bot and to the developer\'s server.',
  ...
  execute: function(message, argsStr, replyData/*, dbData*/) {
    ...
    replyData.discord.fields.push({ name: 'Invite this bot to your server:', value: 'https://discord.com/oauth2/authorize?client_id=593507058905645057&scope=bot%20applications.commands&permissions=2147576904' })
