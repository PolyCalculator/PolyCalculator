...
module.exports = {
    ...
    execute: function (message, argsStr, replyData, dbData) {
        if (argsStr.length < 1) throw 'Input your feedback after the command';

        const calcServer =
            message.client.guilds.cache.get('581872879386492929');
        const feedbackChannel =
            calcServer.channels.cache.get('738926248700411994');
