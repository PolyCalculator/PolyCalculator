    ...
    .then(x => {
      if(!botChannel && auto === false) {
        ...
        message.delete(60000)
          .then(() => console.log(`Message deleted in ${message.channel.name} after 1 min`))
          .catch(console.error)
      }
    })
    .catch(console.error)
