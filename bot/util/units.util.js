...
module.exports.nonnaval = { wa, ri, ar, de, kn, sw, ca, gi, cr, tr, po, na, ga, mb, eg, bd, dr, mo, sl, ic }
module.exports.all = { wa, ri, ar, de, kn, sw, ca, gi, cr, tr, po, na, ga, mb, eg, bd, dr, mo, sl, ic, bo, sh, bs }

module.exports.getFightUnit = function (array, prefix) {
    //return new Promise((resolve, reject) => {
        unitKeys = Object.keys(this.all);
        ...
        unitKey = unitKey.filter(x => this.nonnaval.hasOwnProperty(x.substring(0,2)));
        ...
        unit = Object.assign({},this.nonnaval[unitKey])
