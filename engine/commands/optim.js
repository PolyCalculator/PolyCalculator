...
export const aliases = ['o', 'op', 'opti']
...
export async function execute(message, argsStr, replyData, dbData, targetStr) {
    ...
    try {
        ...
        if (targetStr) {
            ...
            if (targetModifier) {
                defenderArray.splice(defenderArray.indexOf(targetModifier), 1)
        ...
        replyData = await fight.optim(attackers, defender, replyData, target)
