import unitsList from '../units/unitsList.js'
import { handleAliases, poison, boost } from '../effects.js'
...
// Named exports for direct import (tests import `getUnit`; the Edge router uses
// `execute`). Bound to the object so `this` resolves inside the methods.
export const getUnit = units.getUnit.bind(units)
export const execute = units.execute.bind(units)
export const getUnitFromArray = units.getUnitFromArray.bind(units)
export const getBothUnitsArray = units.getBothUnitsArray.bind(units)
export const { name, description, aliases, category } = units
